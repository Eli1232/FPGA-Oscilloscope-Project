...
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { btn1 }]; #IO_L6P_T0_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN B4    IOSTANDARD LVCMOS33 } [get_ports { h_enc_clk }]; #IO_L3P_T0_DQS_34 Sch=pio[46] 
