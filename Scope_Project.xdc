...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { h_gain_up_btn }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { h_gain_down_btn }]; #IO_L11N_T1_SRCC_14 Sch=pio[17]
...
#set_property -dict { PACKAGE_PIN B3    IOSTANDARD LVCMOS33 } [get_ports { h_enc_d }]; #IO_L3N_T0_DQS_34 Sch=pio[45]
